    ...
    <div className="min-h-screen">
      ...
      <table className="my-container border border-gray-400 w-full mt-10">
        <thead className="bg-gray-600">
          ...
          <th className="text-lg text-white border border-gray-400 text-center">Logo</th>
          <th className="text-lg text-white border border-gray-400 text-center">Ketua Umum</th>
